...
project_root = os.path.dirname(os.path.abspath(__file__))  # Path to the src folder
data_dir = os.path.join(project_root, '..', 'data')
output_dir = os.path.join(project_root, '..', 'output')

file_path = os.path.join(data_dir, 'Wall_1.gltf')  # Adjust the filename as needed
...
folder_path = os.path.join(project_root, '..', 'output')
